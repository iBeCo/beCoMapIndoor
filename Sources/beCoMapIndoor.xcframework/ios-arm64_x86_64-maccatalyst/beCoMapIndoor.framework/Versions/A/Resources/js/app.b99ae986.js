...
(function($modules$$) {
  ...
  window.BESetMapLabels = function $window$BESetMapLabels$($geojsonObject$$) {
  ...
  $BeCoMap___webpack_require__$$ = function() {
    ...
    $_createClass$$($BeCoMap$$, [{key:"init", value:function init() {
      ...
      this.vectorLabelLayer = new $_layer$$.Vector({title:"Labels", zIndex:2, displayInLayerSwitcher:!1, declutter:!0, source:new $_Vector$$.default({features:[]}), style:function style($feature$$) {
      ...
      var $_this$$ = this;
      this.vectorRouteLayer = new $_layer$$.Vector({title:"Route Layer", displayInLayerSwitcher:!1, declutter:!0, zIndex:1, renderBuffer:2800, updateWhileAnimating:!0, source:new $_Vector$$.default({features:[]}), style:function style($feature$$, $resolution$$) {
      ...
      return this.map;
    }}, {key:"addLabels", value:function addLabels($geojsonObject$$) {
  ...
  $Label___webpack_require__$$ = function() {
    ...
    $_createClass$$($Label$$, [{key:"toString", value:function toString() {
      return this.name;
    }}, {key:"getFeature", value:function getFeature($geojsonObject$$) {
      return (new $_GeoJSON$$.default).readFeatures($geojsonObject$$);
    }}, {key:"style", value:function style($feature$$) {
      var $font$$ = "normal " + $feature$$.get("size") + 'px "Open Sans", "Arial", "sans-serif"';
      return new $_style$$.Style({text:new $_style$$.Text({font:$font$$, placement:"line", fill:new $_style$$.Fill({color:$feature$$.get("textColor")}), text:$feature$$.get("name"), stroke:new $_style$$.Stroke({color:$feature$$.get("borderColor"), width:3}), overflow:!0})});
    }}]);
    return $Label$$;
  }();
...
//# sourceMappingURL=app.b99ae986.js.map